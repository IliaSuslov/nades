...
const grenades: MapData[] = [
  {
    ...
    grenades: [
      ...
      },
      {
        side: 't',
        type: "fire",
        description: "[A] Site и подъем",
        videoUrl: "https://youtu.be/yp1DcWtv1M8?t=1278",
      },
      {
        side: 't',
        type: "smoke",
    ...
    grenades: [
      {
        side: 't',
        type: "combo",
        description: "[B] site выход нижний",
        videoUrl: "https://youtu.be/W7Qtk8x3S24?t=66",
      },
      {
        side: 't',
        type: "fire",
      ...
      },
      {
        side: 't',
        type: "smoke",
        description: "[B] коннектор",
        videoUrl: "https://youtu.be/Y8PSFoUXNgE?t=316",
      },
      {
        side: 't',
        type: "smoke",
    ...
    grenades: [
      {
        side: "ct",
        type: "прострел",
        description: "[B] просрел типа на раскиде в углу",
        videoUrl: "https://youtu.be/W7Qtk8x3S24?t=1419"
      },
      {
        side: "t",
        type: "fire",
      ...
      },
      {
        side: "ct",
        type: "smoke",
        description: "[B] двери(быстрый)",
        videoUrl: "https://youtu.be/W7Qtk8x3S24?t=1615"
      },
      {
        side: "ct",
        type: "smoke",
        description: "[B] двери со светлой",
      ...
      },
      {
        side: "t",
        type: "combo",
        description: "[B] моли за плент + флеш на пик мяса",
